"""Smoke test for the real ModelNet40 data pipeline."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Smoke test the ModelNet40 dataloader.")
...
def main() -> None:
    ...
    if dataset_name != "modelnet40":
        raise ValueError(
            f"Smoke test expects a ModelNet40 config, but got dataset={dataset_name!r}."
        )
